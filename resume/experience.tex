...
%---------------------------------------------------------
  \cventry
    ...
    {Sep. 2013, Mar. 2011 - Oct. 2011} % Date(s)
    {
      ...
      \end{cvitems}
      %\begin{cvsubentries}
      %  \cvsubentry{}{KNOX(Solution for Enterprise Mobile Security) Penetration Testing}{Sep. 2013}{some description}
      %  \cvsubentry{}{Smart TV Penetration Testing}{Mar. 2011 - Oct. 2011}{some description}
      %\end{cvsubentries}
    }
